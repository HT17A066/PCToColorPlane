...
#ifndef PCTOCOLORPLANE_H
#define PCTOCOLORPLANE_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PCToColorPlane(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  OutPort<RTC::TimedDoubleSeq> m_planeOut;
...
extern "C"
{
  DLL_EXPORT void PCToColorPlaneInit(RTC::Manager* manager);
};

#endif // PCTOCOLORPLANE_H
