...
#include "PCToColorPlaneTest.h"

// Module specification
// <rtc-template block="module_spec">
static const char* pctocolorplane_spec[] =
  {
    "implementation_id", "PCToColorPlaneTest",
    "type_name",         "PCToColorPlaneTest",
 ...
 */
PCToColorPlaneTest::PCToColorPlaneTest(RTC::Manager* manager)
 ...
 * @brief destructor
 */
PCToColorPlaneTest::~PCToColorPlaneTest()
{
}



RTC::ReturnCode_t PCToColorPlaneTest::onInitialize()
{
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onFinalize()
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onStartup(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onShutdown(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
RTC::ReturnCode_t PCToColorPlaneTest::onActivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t PCToColorPlaneTest::onDeactivated(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}


RTC::ReturnCode_t PCToColorPlaneTest::onExecute(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}

/*
RTC::ReturnCode_t PCToColorPlaneTest::onAborting(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onError(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onReset(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onStateUpdate(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
/*
RTC::ReturnCode_t PCToColorPlaneTest::onRateChanged(RTC::UniqueId ec_id)
{
  return RTC::RTC_OK;
}
*/
...
extern "C"
{
  ...
  void PCToColorPlaneTestInit(RTC::Manager* manager)
  {
    coil::Properties profile(pctocolorplane_spec);
    manager->registerFactory(profile,
                             RTC::Create<PCToColorPlaneTest>,
                             RTC::Delete<PCToColorPlaneTest>);
  }
