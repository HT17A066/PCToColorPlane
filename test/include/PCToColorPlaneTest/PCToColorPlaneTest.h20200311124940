...
#ifndef PCTOCOLORPLANE_TEST__H
#define PCTOCOLORPLANE_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PCToColorPlaneTest(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  InPort<RTC::TimedDoubleSeq> m_planeIn;
...
extern "C"
{
  DLL_EXPORT void PCToColorPlaneTestInit(RTC::Manager* manager);
};

#endif // PCTOCOLORPLANE_TEST_H
